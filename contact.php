        ...
        <div data-aos="fade-down" class="col-lg-6 col-md-12 col-sm-12 py-5 " style="background-color:#205cfa;">
          <div class="content px-5">
            ...
            <p style="color:#f1f1f1;" class=" lead py-2">
              ...
              duis magna elit veniam aliqua <br>esse amet veniam enim export
              esse aute nulla ipsum velit export irure minim illum fore</p>
            <p style="color:#f1f1f1;" class=" lead py-2">
              Sed tamen tempor magna labore dolore dolor sint tempor
              quid quid veniam aliqua eram noster<br> malis nulla duis fugiat culpa
              esse aute nulla ipsum velit export irure minim illum fore</p>
    ...
    <div data-aos="fade-down" class="container py-3">
      <div class="form  col-lg-12 col-md-12 col-sm-12 mb-4 ">
        ...
        <form action="" method="post" role="form" class="contactForm">
          ...
          <div class="text-center my-2"><button class="bb rounded-top" type="submit">Send Message</button></div>
        </form>
      </div>
      ...
      <div class="footer mt-5">
        <div>
          ...
          <p>A series of integrated hackathons from idea to MVP to
            ...
            sessions. Innovation Day Hackathon is a unique event style that provide the value of awareness of technology
            to the mass and also to raise the awareness of entrepreneurship to help to launch startups and help
            motivated youth to start their own businesses, We have skilled and talented youth and it’s our time to
            motivate and lead them to make their ideas come true. Also the hackathon is a great opportunity for ideation
            and finding innovative solutions for community problems.
