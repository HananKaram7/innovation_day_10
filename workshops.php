...
<body class="text-capitalize" style="background-color: #101d3d;" >
    <section class=" mb-5">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div data-aos="fade-down" class="col-lg-6 col-md-12 col-sm-12">
                        <div class="hed px-5 py-2" style="background-color: #e8465a;">
                            <h2 class="text-center text-white">deep-dive workshops</h2>
                        </div>
                        <div class="contect item-work ">
        ...
        <!-- <section class="py-5" >
            ...
            <div class="container">
                <div class="row">
                    <div data-aos="fade-down"  class="col-lg-4 col-md-12 col-sm-12 shadow-sm  py-3">
                        <div class="content1 bg-white">
                            <div class="content2 p-3" style="background-color: #f1f1f1;">
                                <p style="color: #205cfa;">1st Day at 18:00 to 20:00</p>
                                <h5 style="color: #205cfa;">MAKE BULLETPROOF DECISIONS</h5>
                            </div>
                            <button  class="c-b text-uppercase btn ml-2 my-3" style="background-color: #e8465a; color: #f1f1f1;">show more</button>
                        </div>

                    </div>
                    <div data-aos="fade-up" class="col-lg-4 col-md-12 col-sm-12 shadow-sm py-3">
                        <div class="content1 bg-white">
                            <div class="content2 p-3" style="background-color: #f1f1f1;">
                                <p style="color: #e8465a;">1st Day at 18:00 to 20:00</p>
                                <h5 style="color: #e8465a;">MAKE BULLETPROOF DECISIONS</h5>
                            </div>
                            <button class="c-b text-uppercase btn ml-2 my-3" style="background-color: #205cfa; color: #f1f1f1;">show more</button>
                        </div>
            ...
            <div class="col-md-4">
                <img class="img-fluid rounded-pill" src="images/abaza.png">
                    ...
                    <div class="col-md-8">
                       ...
                       <h5 class="a-after"></h5>
                       <h6 class="b-after text-capitalize text-muted">workshop speaker</h6>
                       <p style="color: #362d58;">Lorem ipsum dolor sit amet
